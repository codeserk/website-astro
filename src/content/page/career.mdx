...
**BEHOLD**: Some periods overlap, so the sum of all the numbers won't necessarily give you the number of years I've been working!. Although that _does not matter much_, or does it?
