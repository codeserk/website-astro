...
summary:
  format: mdx
  raw: This was one of my _first jobs_, definitely the first one in a large company. I started working for this company when I started the 4th year of my degree in `Computer Science`.
---
