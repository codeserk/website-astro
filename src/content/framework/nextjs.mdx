...
The downside of this technology is that seems to be going through the same path of _let's reinvent [](language/php)_ (to sell cloud computing), which doesn't seem great.
