...
It's now possible to consult the Oracle, and you get a resulting Hexagram. All the graphics and some texts are missing tho, but at least it's possible to use it :)
