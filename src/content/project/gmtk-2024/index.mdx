...
links:
  - name: website
    href: https://alecamara.itch.io/gmtk2024
...
Game result from the GMTK from 2024. _ExpPopulation_.
...
We were able to deliver a game in 48h (we had to work so we couldn't use the full time of the jam). The result can be seen in this website or in [itch.io](https://alecamara.itch.io/gmtk2024)
